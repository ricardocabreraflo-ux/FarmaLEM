...
![Pantalla "Marcar Entrada / Salida": elegir turno, MATUTINO o VESPERTINO, sin abrir sesión](img/marcar-01-elegir-turno.png)

*En computadora:*

![Lo mismo en pantalla de computadora](img/marcar-01-elegir-turno-desktop.png)

Después, igual que en el reloj checador normal, solo pide el **PIN corto**
de esa persona — no su contraseña ni la tuya.

![Pantalla pidiendo el PIN corto de la persona que va a marcar](img/marcar-02-pin.png)

*En computadora:*

![Lo mismo en pantalla de computadora](img/marcar-02-pin-desktop.png)

Confirma su nombre, la hora y si quedó como entrada o salida.

![Confirmación: "Luis Demo", hora, "Entrada registrada · Vespertino", enlaces Marcar otra persona y Regresar](img/marcar-03-confirmacion.png)

*En computadora:*

![Lo mismo en pantalla de computadora](img/marcar-03-confirmacion-desktop.png)
