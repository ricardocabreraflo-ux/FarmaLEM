...
const TUTORIALS: TutorialContent[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "Además: tu historial del mes",
        body: "Debajo del botón de marcar, en la misma pantalla del reloj checador, está “Mi reloj checador” con todas tus entradas y salidas marcadas este mes — útil para revisar tú misma si algo quedó sin marcar.",
        image: "/tutoriales/reloj-04-mi-historial.png",
        imageWidth: 352,
        imageHeight: 710,
        imageDesktop: "/tutoriales/reloj-04-mi-historial-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 648,
        imageAlt: "Tabla “Mi reloj checador” con las entradas y salidas del mes",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        title: "Filtrar la lista de Cortes por fechas",
        body: "En la lista de Cortes, además del selector de mes, hay “O filtra por un rango de fechas específico” — útil para revisar, por ejemplo, justo una quincena o una semana que cruza dos meses.",
      },
    ],
  },
  {
    ...
    audience: "Mostrador",
    summary: "Registra lo que se le niega a un cliente o lo que falta — igual que la hoja de papel del mostrador, pero en el panel.",
    minutes: 3,
    steps: [
      {
        title: "Entra a Negados y faltantes",
        body: "Menú ☰ → Mercancía → “Negados y faltantes”. Arriba ves cuántos quedan pendientes, cuántos se resolvieron hoy y el total registrado. Si una misma sustancia se repite varias veces y sigue pendiente, aparece en un aviso aparte — es una señal de que conviene surtirla pronto. Debajo está el formulario, con dos botones: “Faltante” es un producto que sí manejamos pero se acabó; “Negado” es algo que un cliente pidió y no manejamos en la farmacia.",
        image: "/tutoriales/negados-01-lista.png",
        imageWidth: 352,
        imageHeight: 1717,
        imageDesktop: "/tutoriales/negados-01-lista-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 1011,
        imageAlt: "Pantalla Negados y faltantes con las tarjetas de resumen y el formulario",
        cue: "Empieza casi siempre en “Faltante”",
      },
      {
        title: "Faltante: escanea el código de barras",
        body: "Si el producto tiene código de barras, escanéalo (o cópialo) en el primer campo y toca “Buscar”. Si ya se ha comprado o está en el catálogo de referencia, se autocompletan la sustancia activa, la categoría y el precio de venta — solo revisa y ajusta la cantidad.",
        image: "/tutoriales/negados-02-buscar-encontrado.png",
        imageWidth: 352,
        imageHeight: 1767,
        imageDesktop: "/tutoriales/negados-02-buscar-encontrado-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 1011,
        imageAlt: "Búsqueda por código de barras con los datos autocompletados",
        cue: "“Encontrado — se llenaron los datos conocidos.”",
        cueTone: "ok",
      },
      {
        title: "Registrar",
        body: "Con la sustancia activa capturada (a mano o autocompletada) y la cantidad correcta, toca “Registrar”. Verás “Guardado.”, el formulario se limpia solo y el nuevo registro aparece arriba de la lista.",
        image: "/tutoriales/negados-03-guardado.png",
        imageWidth: 352,
        imageHeight: 1821,
        imageDesktop: "/tutoriales/negados-03-guardado-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 1141,
        imageAlt: "Formulario limpio con el aviso Guardado y el nuevo registro en la lista",
        cue: "El botón no se activa hasta escribir la sustancia activa",
      },
      {
        title: "Negado: cuando no lo manejamos",
        body: "Cambia a “Negado”, escribe el nombre de lo que pidió el cliente, categoría y presentación si las sabes, y anota en “Notas” cualquier detalle (marca específica, por ejemplo). No hay código de barras que buscar porque no es un producto que manejemos.",
        image: "/tutoriales/negados-04-negado.png",
        imageWidth: 352,
        imageHeight: 1771,
        imageDesktop: "/tutoriales/negados-04-negado-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 1141,
        imageAlt: "Formulario en modo Negado con un ejemplo capturado",
      },
      {
        title: "Márcalo Resuelto en cuanto se surta",
        body: "En la columna “Resuelto”, al final de cada fila, hay una casilla — actívala en cuanto ese producto vuelva a estar disponible. Si el Faltante tenía código de barras, se marca solo como resuelto cuando llegue en una recepción de mercancía con ese mismo código, sin que nadie tenga que acordarse de hacerlo a mano.",
        image: "/tutoriales/negados-05-resuelto.png",
        imageWidth: 352,
        imageHeight: 1858,
        imageDesktop: "/tutoriales/negados-05-resuelto-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 1207,
        imageAlt: "Dos registros marcados como Resuelto en la tabla",
        cue: "En el celular, desliza la tabla a los lados para ver la columna Resuelto",
        cueTone: "ok",
      },
    ],
  },
  {
    ...
    audience: "Mostrador",
    summary: "Tus turnos trabajados, tus faltas y tu historial del reloj checador del mes — de solo lectura.",
    minutes: 1,
    steps: [
      {
        title: "Solo ves tu propia asistencia",
        body: "Menú ☰ → Personal → “Asistencia”. Arriba ves cuántos turnos llevas trabajados este mes y cuántas faltas, y debajo tu “Mi reloj checador” con las entradas y salidas del mes — igual que en el Reloj checador. Es de solo lectura: nunca ves la asistencia de tus compañeras, y no puedes editarla ni borrarla tú misma.",
        image: "/tutoriales/asistencia-01-mis-dias.png",
        imageWidth: 352,
        imageHeight: 1435,
        imageDesktop: "/tutoriales/asistencia-01-mis-dias-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 1063,
        imageAlt: "Pantalla Asistencia: turnos, faltas, Mi reloj checador y Mis días",
      },
      {
        title: "Mis días",
        body: "Abajo, “Mis días” lista cada día del mes con tu turno y tu estado (Asistió, Falta, Cubrió turno…). Cada falta afecta únicamente el bono de la semana donde ocurrió, no las demás semanas.",
        cue: "En el celular, desliza la tabla para ver el Estado de cada día",
      },
    ],
  },
  {
    ...
    audience: "Mostrador",
    summary: "Quién cubre cada turno cada día del mes, incluyendo quién dobla el fin de semana.",
    minutes: 1,
    steps: [
      {
        title: "Consulta quién cubre cada turno",
        body: "Menú ☰ → Personal → “Calendario de turnos”. Entre semana cada quien cubre su turno fijo; el fin de semana solo una persona dobla el día completo (Matutino + Vespertino), alternando cada fin de semana — se marca “DOBLE”.",
        image: "/tutoriales/calendario-turnos-01-grid.png",
        imageWidth: 352,
        imageHeight: 1213,
        imageDesktop: "/tutoriales/calendario-turnos-01-grid-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 1068,
        imageAlt: "Calendario de turnos del mes, con Ana y Luis y el fin de semana marcado DOBLE",
        cue: "En el celular, desliza la tabla para ver el resto de la semana",
      },
      {
        title: "Si necesitas cambiar de turno con alguien",
        body: "Las notas de abajo del calendario lo resumen: el cambio de turno es bajo autorización previa, se debe notificar con una a dos semanas de anticipación, y una falta equivale a perder el bono semanal completo.",
      },
    ],
  },
  {
    ...
    audience: "Mostrador",
    summary: "Tus ventas, si alcanzaste nivel de bono y cuánto cada semana — se calculan solos, de solo lectura.",
    minutes: 1,
    steps: [
      {
        title: "Solo ves tus propias semanas",
        body: "Menú ☰ → Personal → “Bonos semanales”. Arriba ves cuánto llevas ganado en bonos este mes, en cuántas semanas alcanzaste algún nivel y en cuántas lo perdiste por una falta. Las semanas ya terminadas se calculan solas, sin que nadie tenga que capturarlas a mano.",
        image: "/tutoriales/bonos-01-resultados.png",
        imageWidth: 352,
        imageHeight: 1149,
        imageDesktop: "/tutoriales/bonos-01-resultados-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 884,
        imageAlt: "Pantalla Bonos semanales: resumen, resultados semanales y pirámide de metas",
      },
      {
        title: "Pirámide de metas",
        body: "Debajo de tus resultados está la pirámide de metas del mes para tu turno: cuánto hay que vender en la semana para cada nivel y cuánto es el bono de cada uno.",
      },
    ],
  },
  {
    ...
    audience: "Todo el equipo",
    summary: "Qué anaqueles y vitrina le tocan limpiar y revisar a cada turno esta semana.",
    minutes: 1,
    steps: [
      {
        title: "Quién limpia y revisa cada anaquel",
        body: "Menú ☰ → Personal → “Distribución de anaqueles”. El croquis muestra la numeración de cada anaquel; debajo, cada turno ve qué números y qué vitrina le tocan este mes. Rola solo cada mes (según sea mes non o par) — no hay que acordarse ni configurarlo a mano.",
        image: "/tutoriales/anaqueles-01-mes.png",
        imageWidth: 352,
        imageHeight: 904,
        imageDesktop: "/tutoriales/anaqueles-01-mes-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 1377,
        imageAlt: "Croquis de anaqueles con los números y vitrina de cada turno",
      },
    ],
  },
  {
    ...
    audience: "Todo el equipo",
    summary: "La limpieza semanal fija por anaquel, más qué categoría de inventario toca contar cada día.",
    minutes: 2,
    steps: [
      {
        title: "Limpieza semanal",
        body: "Menú ☰ → Personal → “Calendario de actividades”. La tabla de arriba (“Limpieza semanal”) es igual todas las semanas del año: qué anaqueles y qué más (baño, consultorio, vitrina) le toca limpiar a cada turno cada día.",
        image: "/tutoriales/actividades-01-mes.png",
        imageWidth: 352,
        imageHeight: 1754,
        imageDesktop: "/tutoriales/actividades-01-mes-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 1221,
        imageAlt: "Tabla de limpieza semanal y calendario de inventario del día",
        cue: "En la computadora se lee más cómodo el calendario completo",
      },
      {
        title: "Inventario del día",
        body: "Debajo, el calendario del mes reparte las 8 categorías de inventario (Sueltos, Vitaminas, Antibióticos, Genérico, Patente, Dulcería, Perfumería 1 y 2) un día distinto cada vez, sin repetirse — se cuenta entre quien esté ese día, sin importar el turno. Sábado y domingo además llevan la vitrina y los 2 anaqueles del turno en curso (eso lo define Distribución de anaqueles).",
      },
    ],
  },
  {
    ...
    summary: "Los precios de venta exportados de SICAR X, para comparar contra el costo cuando ya se conoce.",
    minutes: 1,
    steps: [
      {
        title: "Búscalo por clave, descripción o categoría",
        body: "Menú ☰ → Mercancía → “Catálogo de productos”. Es la lista de precios de venta que se exportó de SICAR X — sirve para consultar y comparar contra el costo una vez que se conoce (por lo que se ha recibido en Recepción de mercancía). No representa existencias: un producto puede aparecer aquí y estar agotado, o al revés. Usa el buscador para encontrar uno por su clave, su descripción o su categoría.",
        image: "/tutoriales/catalogo-01-lista.png",
        imageWidth: 352,
        imageHeight: 739,
        imageDesktop: "/tutoriales/catalogo-01-lista-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 495,
        imageAlt: "Catálogo de productos con la tabla de precio, precio neto, costo y margen",
      },
      {
        title: "Precio, costo y margen",
        body: "Cada renglón trae el precio de venta y el precio neto (después de descuentos), y cuando ya se conoce el costo por haberlo recibido en una recepción, también el costo y el margen — la diferencia entre el precio y el costo, en pesos y en porcentaje.",
        cue: "En el celular, desliza la tabla a los lados para ver Costo y Margen",
      },
    ],
  },
  {
    ...
    audience: "Mostrador Plus",
    summary: "Consulta las recepciones de mercancía ya capturadas y, si falta alguna clave, captúrala a mano en SICAR X con los datos del ticket.",
    minutes: 3,
    steps: [
      {
        title: "La lista de recepciones",
        body: "Menú ☰ → Mercancía → “Recepción de mercancía”. Arriba ves el total de recepciones, piezas recibidas y costo total. Debajo, cada recepción con su proveedor, ticket, piezas, importe y estado (“Pendiente” o “Completa”), más si ya se acomodó en la farmacia y si ya se capturó en el sistema — esas dos últimas solo se pueden marcar desde acá si eres administración; a ti te aparecen como referencia. Toca “Ver” para entrar al detalle. Capturar una recepción nueva (el botón “+ Nueva recepción”) es solo de administración.",
        image: "/tutoriales/compras-01-lista.png",
        imageWidth: 352,
        imageHeight: 1272,
        imageDesktop: "/tutoriales/compras-01-lista-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 862,
        imageAlt: "Recepción de mercancía: tarjetas de resumen, lista de recepciones y todas las piezas recibidas",
        cue: "Más abajo, “Todas las piezas recibidas” junta los renglones de todas las recepciones",
      },
      {
        title: "Una recepción Completa",
        body: "El detalle muestra el proveedor y el ticket, el importe del ticket contra la suma de los renglones capturados (con la diferencia, si la hay), las piezas del ticket y la tabla de renglones recibidos, ya con su código de barras, costo, precio, lote y caducidad. Los botones “Excel FarmaLEM” y “Excel SICAR X” exportan esa recepción para el otro sistema.",
        image: "/tutoriales/compras-02-detalle-completa.png",
        imageWidth: 352,
        imageHeight: 1040,
        imageDesktop: "/tutoriales/compras-02-detalle-completa-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 515,
        imageAlt: "Detalle de una recepción Completa con sus renglones recibidos",
      },
      {
        title: "Una recepción Pendiente: captúrala en SICAR X",
        body: "Cuando un renglón del ticket todavía no tiene código de barras o precio ligado en FarmaLEM, la recepción se queda en “Pendiente” y ese renglón aparece arriba, en “Renglones por capturar”, con los datos tal como vienen en el ticket (descripción, piezas, precio, lote y caducidad). Esa tabla es de solo lectura para ti — captura esos mismos datos a mano en SICAR X; quien complete el renglón en FarmaLEM es administración.",
        image: "/tutoriales/compras-03-detalle-pendiente.png",
        imageWidth: 352,
        imageHeight: 1461,
        imageDesktop: "/tutoriales/compras-03-detalle-pendiente-desktop.png",
        imageDesktopWidth: 1192,
        imageDesktopHeight: 789,
        imageAlt: "Detalle de una recepción Pendiente con la tabla Renglones por capturar",
        cue: "En el celular, desliza la tabla para ver todos los datos del renglón",
      },
    ],
  },
  {
